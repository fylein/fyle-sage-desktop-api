...
"""
from .apis import Accounts, Vendors, Jobs, Commitments, Documents, OperationStatus, Categories, CostCodes, DirectCosts, EventFaliure
...
class SageDesktopSDK:
    ...
    def __init__(self, api_key: str, api_secret: str,  user_name: str, password: str, indentifier: str):
        ...
        self.events_faliure = EventFaliure()
    ...
    def update_user_id_and_password(self):
        ...
        self.events_faliure.set_user_id_and_password(self.__user_name, self.__password)
    ...
    def update_api_url(self):
        ...
        self.events_faliure.set_api_url(self.__indentifier)
    ...
    def update_cookie(self):
        ...
        self.events_faliure.update_cookie(self.__api_key, self.__api_secret)
