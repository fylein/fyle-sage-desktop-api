    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workspace', models.OneToOneField(help_text='Reference to Workspace model', on_delete=django.db.models.deletion.PROTECT, related_name='dependent_field_settings', to='workspaces.workspace')),
            ],
            options={
