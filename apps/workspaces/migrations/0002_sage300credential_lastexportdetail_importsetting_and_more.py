# Generated by Django 4.1.2 on 2023-12-11 19:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reimbursable_expense_date', sage_desktop_api.models.fields.StringOptionsField(choices=[('LAST_SPENT_AT', 'last_spent_at'), ('CURRENT_DATE', 'current_date'), ('SPENT_AT', 'spent_at')], default='', help_text='string field with options', max_length=255, null=True)),
                ...
                ('credit_card_expense_date', sage_desktop_api.models.fields.StringOptionsField(choices=[('LAST_SPENT_AT', 'last_spent_at'), ('POSTED_AT', 'posted_at')], default='', help_text='string field with options', max_length=255, null=True)),
